...
``` bash
wget https://raw.githubusercontent.com/BiodataAnalysisGroup/RNAseq_analysis/main/bash/star.sh
```

``` bash
wget https://raw.githubusercontent.com/BiodataAnalysisGroup/RNAseq_analysis/main/bash/runSTAR.sh 
```
