...
``` bash
nohup bash runCOVID19.sh /mnt/new_home/stamatopoulos_research/SARS_2025_05_21 SampleList /work/covid19-runs/ref/NC_045512.2.fasta &
```
...
``` bash
rsync -r SARS_2025_05_21 /mnt/new_home/stamatopoulos_research
```
